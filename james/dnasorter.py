...
def sortdnas(inputfile: str, _stratname: str, stratclass, _top: int = 25, _rng: int = 100, _criteria: str = 'pnl1'):
    ...
    dnafilename = f'{jamesdir}/dnafiles/{_stratname}dnas.py'
...
def valideoutputfile(_sortedbesties, _stratname):
    p = f'{jamesdir}.dnafiles.{_stratname}dnas'
    # {jamesdir}.dnafiles.wtewoHyper2dnas
...
if __name__ == "__main__":
    ...
    sortedbesties = sortdnas('{jamesdir}/ewoHyper2-Binance-BTC-USDT-2h.txt', strategy, StrategyClass, 25, 100)
